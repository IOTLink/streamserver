...
func (fabricCAServices *FabricCA)DeepCopyFabricCAClient() (*FabricCA, error) {
	caClient := *fabricCAServices.fabricCAClient
	fCAServices := *fabricCAServices
	fCAServices.fabricCAClient = &caClient
	return &fCAServices, nil
}
